...
exports.resetForgot = catchAsync(async (req, res, next) => {
    ...
    const user = await User.findOne({ email: email }).select("+tokenresetpw +tokenresettime");
...
exports.resetPassword = catchAsync(async (req, res, next) => {
    ...
    const checkpasswordold = await req.body.user.checkPassword(password, req.body.user.password);
